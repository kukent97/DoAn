...
<head>
	...
	.ThongBao{background-color:#e0e0e0; border: 0px solid DarkSlateGray;padding-left:480px; padding-top:85px;color:DarkOliveGreen; font-size: 20px; 
			width:625px; height: 150px;position:relative; left:285px;top:-1624px;border-radius: 10px}	
	...
	.TaiLieu{background-color: #e0e0e0;width: 418px;height: 00px;position: relative;top: -96px;left: 922px;border-radius: 10px}
...
<div id="modal">
	...
	<tr>
	<th><b class="ADMIN" style="padding-left:10px;font-size:23px ;margin-right:100px" >HỌC VIÊN</b></th>
		...
		<tr><th align ="center" style="padding-left:140px;padding-top:05px;padding-bottom:05px;border-bottom: #000 solid 2px;font-size: 20px ">
	   	...
	   	<tr><th >
	   		<div class="TaiLieu1">
				...
				<div style="background-color: #fff;margin-left: 10px;margin-top: 10px;width: 367px;border-radius: 10px;position:relative;top:0px">

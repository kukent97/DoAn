...
<head>
	...
	.ha{color: RoyalBlue; font-size: 30px; width:600px;}
 	...
 	.table1{background-color:PaleTurquoise !important;text-aglign="left";text-color:red;color:DarkSlateGray;position:relative; left:7px;top:97px ;
	...
	.ThongBao{background-color:#e0e0e0; border: 0px solid DarkSlateGray;padding-left:480px; padding-top:85px;color:DarkOliveGreen; font-size: 20px; 
			width:625px; height: 150px;position:relative; left:285px;top:-1622px;border-radius: 10px}	
	...
	.TaiLieu{background-color: #e0e0e0;width: 418px;height: 00px;position: relative;top: -94px;left: 922px;border-radius: 10px}
	.TaiLieu1{width: 380px;height: 1220px}
	.ThongBao1{ width:630px; height: 1450px}
...
<div id="modal">
	...
	<table class="table2" style="border-top: #ff0000 solid 2px;border-bottom: #ff0000 solid 2px">
		<tr>
		<th><b style="padding-left:10px;font-size:23px;margin-right: 200px ">NGƯỜI QUẢN LÝ CÂU HỎI</b></th>
		<th><a href="logout"><u class="tb2">ĐĂNG XUẤT</u></a></th>
		</tr>      
	</table> 

 	<table class="table1" border="0px" cellpadding="15px" >
    	<tr><th  class="tbl1"><a href="nqlch_trangChu" style="color:DarkBlue"><span class="glyphicon glyphicon-home"></span>TRANG CHỦ</a></th></tr><br>

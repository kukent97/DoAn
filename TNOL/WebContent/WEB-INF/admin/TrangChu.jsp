...
<head>
	...
	.ha{color: RoyalBlue; font-size: 30px; width:600px;}
  	label {color:DarkRed;}
        #modal{position: absolute;top:0%;left: 0%;  -moz-transform: translate(0%,0%);transform: translate(0%,0%);
            z-index: 999;width:90%;height: 350%}
        ...
        .modal-content button{font-size: 15px; text-align: center;margin-left: 78%;margin-top:0px;width:10%;height: 30%}
        .modal-footer{position:absolute;background-color:#50c1e9;padding: 5px 10px;bottom: 0px;left: 0px;width: 100%}
        .modal-footer hh{margin-right: 200px;float: right;color:#000;text-decoration: none}
	...
	.ThongBao{background-color:#e0e0e0; border: 0px solid DarkSlateGray;padding-left:480px; padding-top:85px;color:DarkOliveGreen; font-size: 20px; 
			width:625px; height: 150px;position:relative; left:285px;top:-1735px;border-radius: 10px}	
	...
	.TaiLieu{background-color: #e0e0e0;width: 418px;height: 00px;position: relative;top: -205px;left: 922px;border-radius: 10px}
	.TaiLieu1{width: 410px;height: 1220px}
	.ThongBao1{ width:630px; height: 1450px;overflow:auto}
...
<div id="modal">
	...
	<th><a href="logout"><u class="tb2" >ĐĂNG XUẤT</u></a></th>
 	...
 	<table class="table1" border="0px" cellpadding="15px">
    		<tr><th align ="left" class="tbl1"><a href="trangChuList" style="color:DarkBlue"><span class="glyphicon glyphicon-home"></span>TRANG CHỦ</a></th></tr><br>

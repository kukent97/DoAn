...
<title>Insert title here</title>
	...
	.ThemNQL1{position: fixed;left: -50px;font-size: 23px;border-radius: 7px;width:390px}
	.ThemNQL3{position: fixed;left: -350px;font-size: 23px;width:500px}
	...
	#TieuDe{margin-left:-162px;margin-top:-5px}
	#Tep{margin-left:-162px;margin-top:10px}
	#TepDinhKem{width: 600px; position:relative;left: 160px;top:-62px}
 		...
 		<div class"than" style="width:100%;height:1600px;position:fixed;top:400px">
			...
			<th><a href="logout"><u class="tb2" >ĐĂNG XUẤT</u></a></th>
 			...
 			<table class="table1" border="0px" cellpadding="15px">
  			...
  			<b style="font-size: 35px; color:DarkSlateGray">Danh sách thông báo</b>
 				<div class="Timkiemtheo">
					...
					<div style="overflow:auto;height:800px;width:980px">
					<table class="table" border="2px" style="margin-left: 0px;width:965px">
					    <thead>
					      <tr>
					        <th style="text-align: center">Tên thông báo</th>
					        <th></th>
					    ...
					    <tbody id="noidung">
						    <c:forEach var="TB" items="${requestScope.listThongBao}">
							    <tr>
							        <td style="width:500px">${TB.getTitle()}</</td>
							        <td style="width:200px;text-align:center"><a href="chiTietThongBao?maTB=${TB.getNoticeId()}">Chi tiết thông báo</a></td>
							        <td style="text-align:center;width:150px"><a href="admin_thongBao?maThongBao=${TB.getNoticeId() }&command=edit"><span class="glyphicon glyphicon-cog"></span></a></td>
								    <td style="text-align:center;padding:7px"><a href="admin_thongBao?maThongBao=${TB.getNoticeId() }&command=delete"><span class="glyphicon glyphicon-trash"></span></a></td>
							      </tr>
						    </c:forEach>
					    </tbody>
					  </table>
...
<div class="container" style="position:relative;top:0px;left:0px" id="themUser" >
	...
	<button type="button" class="btn1 btn-info btn-lg" data-toggle="modal" data-target="#phucModal"><b>Đăng thông báo</b></button>
	<!-- Modal -->
		...
		<div class="modal-dialog" style="position: relative;top: 0px;left: 0px;width: 00px">
			...
			<div class="modal-content" style="position: relative;top: 0px;left: -400px;width: 800px;background-color:DarkSeaGreen">
					<div class="modal-header" style="position: relative;top: 0px;left: 0px;width: 795px">
						...
						<h4 class="modal-title" style="position: relative;top: 0px;left: 0px"><span class="glyphicon glyphicon-pencil"></span><b style="margin-left:12px">Đăng thông báo</b></h4>
					</div>
					<div class="modal-body" style="position: relative;top: 0px;left: 0px;width: 800px;height: 450px">
						<p>
						<form  action="admin_thongBao" id="themThongBao">
							<br>
							<input id="TieuDe" type="text" class="form-control" name="tieuDe" placeholder="Tiêu đề thông báo" style="width: 600px">
							<u>Nội dung:</u>
							<textarea name="noiDungThongBao" style="width: 750px;height: 230px;border-radius: 8px;color:black" id="noiDung2"></textarea><br>
							<br>
							<input id="Tep" type="button" class="form-control" name="Tep" value="Link đính kèm" style="width: 150px;height:45px; font-size:20px;background-color: DarkSeaGreen">
						    <input id="TepDinhKem" type="text" class="form-control" name="linkDinhKem" placeholder="Không có link đính kèm">
						</form>
						</p>
					</div>
					<div class="modal-footer" style="position: relative;top: 0px;left: 0px;width: 795px">
						...
						<button type="submit" class="btn" id="btnThem" form="themThongBao" value="insert" name="command">Thêm thông báo</button>
					</div>
				</div>
		</div>
	</div>

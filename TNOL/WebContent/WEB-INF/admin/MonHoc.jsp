...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	#searchbox {position: relative;left: 130px;top:-18px;
	...
	.ThemNQL1{position: fixed;left: -100px;font-size: 23px;border-radius: 7px;width:370px}
 		...
 		<div class"than" style="width:100%;height:1600px;position:fixed;top:400px">
			...
			<th><a href="logout"><u class="tb2" >ĐĂNG XUẤT</u></a></th>
 			...
 			<table class="table1" border="0px" cellpadding="15px">
		    	...
		    	<tr><th align ="left" class="tbl1"><a href="monHocList" style="color:DarkBlue">DANH SÁCH MÔN HỌC</a></tH></tr><br>
  			...
  			<b style="font-size: 35px; color:DarkSlateGray">Danh sách môn học</b>
  			<div class="Timkiemtheo">
				...
				<input id="button-submit" type="button" value=" "/>
				</form><br><br><br>
				    ...
				    <tbody id="noidung">
					    <c:forEach var="mh" items="${requestScope.listMonHoc}">
						    <tr>
						        ...
						        <td style="text-align: center"><a href="admin_monHoc_delete?maMonHoc=${mh.getSubjectId()}&command=edit">Edit</a></td>
						        <td style="text-align: center"><a href="admin_monHoc_delete?maMonHoc=${mh.getSubjectId()}&command=delete">Delete</a></td>
						      </tr>
					    </c:forEach>
				    </tbody>
				  </table>
...
<div class="container" style="position:relative;top:0px;left:0px" id="themUser" >
	<button type="button" class="btn1 btn-info btn-lg" data-toggle="modal" data-target="#phucModal"><b>Thêm môn học</b></button>
	<!-- Modal -->
	<div class="modal fade" id="phucModal" role="dialog" >
		<div class="modal-dialog" style="position: relative;top: 0px;left: 0px;width: 00px">
			<!-- Modal content-->
			<div class="modal-content" style="position: relative;top: 0px;left: -300px;width: 600px;background-color:DarkSeaGreen">
				<form action="admin_monHoc_delete" method="get" id="insert">
				<div class="modal-header" style="position: relative;top: 0px;left: 0px;width: 595px">
					<button type="button" class="close" data-dismiss="modal" style="position: relative;top: 0px;left: 0px;z-index: 9999" href="trangChuList">&times;</button>
					<h4 class="modal-title" style="position: relative;top: 0px;left: 0px"><span class="glyphicon glyphicon-pencil"></span><b style="margin-left:12px">Thêm môn học</b></h4>
				</div>
				<div class="modal-body" style="position: relative;top: 0px;left: 0px;width: 600px;height: 150px">
					<p>
					<br><br>
						<b class="ThemNQL3">Tên môn học:</b>
 						<input type="text" name="tenMonHoc" class="ThemNQL1" required="required" >
						<br><br>
					</p>
				</div>
				<div class="modal-footer" style="position: relative;top: 0px;left: 0px;width: 595px">
		...
		$("#insert").validate(
				{
					...
					messages : {
						tenMonHoc : "Không bỏ trống tên môn học ^^",
					}
				});
	});
</script>

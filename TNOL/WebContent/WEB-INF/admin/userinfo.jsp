...
<div id="my">
	...
	<div class="HienThongTin">
		...
		username: ${requestScope.userAdmin.getUsername()} <br><br>
		Họ tên: ${requestScope.userAdmin.getFullname()}<br><br>
		Giới tính: ${requestScope.userAdmin.getSex()}<br><br>
		Ngày sinh: ${requestScope.userAdmin.getBirthday()}<br>
		</div>
		</div>	<br><br>
		...
		Số điện thoại: ${requestScope.userAdmin.getPhone()}<br><br>
		</div>
		</div>
		...
		<a href="admin_info_edit"><u style="position :relative;top:-250px;left:0px">CHỈNH SỬA THÔNG TIN</u></a>
		</div>
</div>

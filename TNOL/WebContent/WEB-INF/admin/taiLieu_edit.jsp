...
<div id="my">
	...
	<div class="HienThongTin">
		<b style="font-size: 35px; color:DarkRed"><span class="glyphicon glyphicon-pencil"></span>Chỉnh sửa tài liệu</b><br><br><br>
		<div class="iamge"><img src="${requestScope.getTaiLieu.getImage() }" style="border-radius: 10px;max-width:250px;max-height:170px"></div>
		...
		<form action="admin_taiLieu_anh" method="post" enctype="multipart/form-data" id="canAn" >
			<div id="bb">
		...
		<form action="admin_taiLieu_edit" id="editTaiLieu" method="post" style="margin-top:-40px">
			<br><br>
			<b class="ThemNQL3">Tên tài liệu:</b><br>
			<textarea class="ThemNQL1" name="tenTaiLieu" style="width: 750px;height: 150px;border-radius: 8px;color:black;background-color:#F7F8E0" id="noiDung2"> ${requestScope.getTaiLieu.getTitle()}</textarea><br><br>	
			<b class="ThemNQL3">Link tài liệu:</b><br>
			<input class="ThemNQL1" id="TieuDe" type="text" value="${requestScope.getTaiLieu.getLink()}" class="form-control" name="link" placeholder="Nhập tiêu đề thông báo" style="width:750px;background-color:#F7F8E0"><br>
		</form>
		<form action="taiLieuList">
			<button type="submit" class="btn" id="btnXoa" onclick="getBack()">Hủy</a></button>
		</form>
			<button type="submit" class="btn" id="btnThem" value="edit" name="command" form="editTaiLieu">Lưu thay đổi</button>
	</div>
</div>

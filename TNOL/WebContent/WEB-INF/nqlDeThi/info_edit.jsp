...
<head>
	...
	.HienThongTin{background-color:#e0e0e0; border: 0px solid DarkSlateGray;padding-left:480px; padding-top:85px;color: red ; font-size: 20px;
			 width:1050px; height: 1000px;position:relative; left:285px;top:-325px;border-radius: 10px}
	...
	#btnThem{background-color: #67BF7F;color: DarkSlateGrey;font-size:18px;margin-top:-500px;margin-left:110px;padding:5px 15px;width:180px}
	...
	.ThemNQL1{position:fixed;left:925px;border-radius: 5px;width:280px;background-color:#F7F8E0}
...
<div id="my">
	...
	<div class="HienThongTin">
		...
		<form action="nqldt_info_edit" method="post" id="edit">
		...
		<div class="iamge"><img src="${requestScope.userAdmin.getAvatar()}" style="border-radius: 10px;max-width:200px;max-height:270px" ></div>
			<form action="nqldt_userInfo">
				<button type="submit" class="btn" id="btnXoa" data-dismiss="modal" ><span class="glyphicon glyphicon-remove" style="margin-top: 5px"></span><b style="margin-left:20px">Hủy</></button>
			</form>

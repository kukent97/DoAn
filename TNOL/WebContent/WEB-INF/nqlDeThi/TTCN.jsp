...
<div id="my">
	...
	<th><a href="logout"><u class="tb2">ĐĂNG XUẤT</u></a></th>
 	...
 	<table class="table1" border="0px" cellpadding="15px">
    	...
    	<tr><th align ="left" class="tbl1"><a href="nqldt_userInfo" style="color:DarkBlue">THÔNG TIN CÁ NHÂN</a></th></tr>
	...
	<div class="HienThongTin">
		...
		username: ${requestScope.us.getUsername()} <br><br>
		Họ tên: ${requestScope.us.getFullname()}<br><br>
		Giới tính: ${requestScope.us.getSex()}<br><br>
		Ngày sinh: ${requestScope.us.getBirthday()}<br>
		</div>
		</div>	<br><br>
		...
		Số điện thoại: ${requestScope.us.getPhone()}<br><br>
		</div>
		</div>
	
		<div class="iamge"><img src="${requestScope.us.getAvatar()}" style="border-radius: 10px;max-width:200px;max-height:270px" ></div>
		<button class="Anh" style="position:relative;left:-325px;top:-610px;border-radius: 10px;height:47px" id="nhapvo"><span class="glyphicon glyphicon-camera"></span>CHỈNH SỬA ẢNH</button><br>
		...
		<a href="nqldt_info_edit"><u class="tb2" style="position :relative;top:-245px;left:0px">CHỈNH SỬA THÔNG TIN</u></a>
		</div>
</div>

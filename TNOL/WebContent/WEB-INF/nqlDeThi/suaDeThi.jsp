...
<head>
	...
	width:1050px; height: 932px;position:relative; left:285px;top:-325px;border-radius: 10px}
	...
	.soLuongCauHoi{position:fixed;left:550px;width:250px;border-radius: 5px}
	.buttons {
	  $w: 500px;
	  $h: 260px;
	  position: absolute;
...
<div id="modal">
	...
	<th><a href="logout"><u class="tb2" >ĐĂNG XUẤT</u></a></th>
 		...
 		<div class="HienThongTin">
			...
			<input id="TieuDe" type="text" class="form-control" name="tenDeThi" placeholder="Tên đề thi" style="width: 600px;font-size:20px"><br>
			<b style="color:#000">Thời gian thi:</b> 
			<input id="TieuDe" type="text" class="form-control" name="thoiGianThi" placeholder="Thời gian thi" style="width: 600px;font-size:20px"><br>
			<b style="color:#000">Người tạo đề thi:</b> 
			<input id="TieuDe" type="text" class="form-control" name="nguoiTaoDeThi" value="${requestScope.nguoiDung.getFullname() }" readonly style="width: 600px;font-size:20px"><br>
			
				<b style="color:#000">Môn học:
				<select name="color" data-toggle="dropdown" style="width:250px;border-radius: 5px" id="monHocChose">
				...
				<select name="color" data-toggle="dropdown" style="width:250px;border-radius: 5px" id="nhomCauHoiChose">
				</select>
				<input id="themNhomCauHoi" type="button" class="button" name="them" value="Thêm" style="width: 150px;height:45px; font-size:20px;background-color: LightBlue;color:Black;position: relative;;left: 0px;top:0px;border-radius: 8px">
				<br><br>
				<div id="themNCH"></div>
				<br><br><br><input id="themDeThi" type="submit" class="button" name="them" value="Thêm DT" style="width: 150px;height:45px; font-size:20px;background-color: LightBlue;color:Black;position: relative;;left: 650px;top:-45px;border-radius: 8px">
			</form>	
   			 <br><br>
  			  <br>
...
<script>
	$("#themNhomCauHoi").click(function(){
		...
		var soLuongCauHoi="<input type='text' name='soLuongCauHoi_"+nhomCH.val()+"'class='soLuongCauHoi' placeholder='Nhập số lượng câu hỏi'/>";

...
@WebServlet("/hocVien_info_edit")
public class hocVien_info_edit extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public hocVien_info_edit() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/hocvien/info_edit.jsp").forward(request, response);
	}

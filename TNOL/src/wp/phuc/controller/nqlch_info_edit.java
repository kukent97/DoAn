...
@WebServlet("/nqlch_info_edit")
public class nqlch_info_edit extends HttpServlet {
	private static final long serialVersionUID = 1L;
 
    public nqlch_info_edit() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/nqlCauHoi/info_edit.jsp").forward(request, response);
	}

...
@WebServlet("/admin_info_edit")
public class admin_info_edit extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public admin_info_edit() {
        super();
    }
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("WEB-INF/admin/info_edit.jsp").forward(request, response);
	}
